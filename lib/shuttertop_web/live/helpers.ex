defmodule ShuttertopWeb.LiveView.Helpers do
  @moduledoc false
  import Plug.Conn
  ...
  def param_date(%{} = params, param) do
    try do
      if is_binary(params[param]) do
        Map.put(params, param, "#{params[param]}T23:59:59.000")
      end
    rescue
      e in RuntimeError ->
  ...
  @spec get_entity_name(User.t() | Contest.t() | Photo.t()) :: binary()
  def get_entity_name(%User{}), do: "user"
  def get_entity_name(%Contest{}), do: "contest"
  def get_entity_name(%Photo{}), do: "photo"
